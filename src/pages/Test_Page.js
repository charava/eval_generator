...
import { saveAs } from 'file-saver'; // make sure you run "npm install file-saver --save" to use this
...
class Test_Page extends Component {
    ...
    saveToFile = () => {
        // Basic file download implementation based on https://github.com/eligrey/FileSaver.js
        var FileSaver = require('file-saver');
        var blob = new Blob([this.state.eval],
                { type: "text/plain;charset=utf-8" });

        FileSaver.saveAs(blob, 'eval.txt')
    };
